...
wget -N http://www.emacswiki.org/emacs-se/download/xclip.el
wget -N http://www.emacswiki.org/emacs-se/download/shell-completion.el
wget -N http://www.wonderworks.com/download/redo.el
